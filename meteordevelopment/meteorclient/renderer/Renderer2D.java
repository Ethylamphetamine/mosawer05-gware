...
public class Renderer2D {
    ...
    public Renderer2D(boolean texture) {
        Mesh.Attrib[] attribArray;
        Shader shader = texture ? Shaders.POS_TEX_COLOR : Shaders.POS_COLOR;
        if (texture) {
            Mesh.Attrib[] attribArray2 = new Mesh.Attrib[3];
            attribArray2[0] = Mesh.Attrib.Vec2;
            attribArray2[1] = Mesh.Attrib.Vec2;
            attribArray = attribArray2;
            attribArray2[2] = Mesh.Attrib.Color;
        } else {
            Mesh.Attrib[] attribArray3 = new Mesh.Attrib[2];
            attribArray3[0] = Mesh.Attrib.Vec2;
            attribArray = attribArray3;
            attribArray3[1] = Mesh.Attrib.Color;
        }
        this.triangles = new ShaderMesh(shader, DrawMode.Triangles, attribArray);
