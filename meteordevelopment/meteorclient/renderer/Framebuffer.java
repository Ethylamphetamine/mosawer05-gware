...
public class Framebuffer {
    ...
    private void init() {
        ...
        this.width = (int)((double)MeteorClient.mc.getWindow().getFramebufferWidth() * this.sizeMulti);
        this.height = (int)((double)MeteorClient.mc.getWindow().getFramebufferHeight() * this.sizeMulti);
