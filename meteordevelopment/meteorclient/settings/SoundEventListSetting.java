...
extends Setting<List<SoundEvent>> {
    ...
    protected List<SoundEvent> parseImpl(String str) {
        ...
        try {
            for (String value : values) {
                SoundEvent sound = (SoundEvent)SoundEventListSetting.parseId(Registries.SOUND_EVENT, value);
    ...
    public NbtCompound save(NbtCompound tag) {
        ...
        for (SoundEvent sound : (List)this.get()) {
            Identifier id = Registries.SOUND_EVENT.getId((Object)sound);
            if (id == null) continue;
    ...
    public List<SoundEvent> load(NbtCompound tag) {
        ...
        for (NbtElement tagI : valueTag) {
            SoundEvent soundEvent = (SoundEvent)Registries.SOUND_EVENT.get(Identifier.of((String)tagI.asString()));
