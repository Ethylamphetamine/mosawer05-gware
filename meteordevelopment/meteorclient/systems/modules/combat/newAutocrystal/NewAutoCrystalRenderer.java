...
public class NewAutoCrystalRenderer {
    private final Settings settings = new Settings();
    private final SettingGroup sgRender = this.settings.createGroup("Render");
    private final NewAutoCrystal autoCrystal;
    ...
    public NewAutoCrystalRenderer(NewAutoCrystal ac) {
        this.autoCrystal = ac;
    ...
    private class CrystalBreakRender {
        ...
        private CrystalBreakRender(NewAutoCrystalRenderer newAutoCrystalRenderer) {
        }
    }
}
