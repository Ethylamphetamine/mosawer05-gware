...
implements Socks5CommandResponse {
    ...
    public DefaultSocks5CommandResponse(Socks5CommandStatus status, Socks5AddressType bndAddrType, String bndAddr, int bndPort) {
        ObjectUtil.checkNotNull((Object)status, (String)"status");
        ObjectUtil.checkNotNull((Object)bndAddrType, (String)"bndAddrType");
        if (bndAddr != null) {
            if (bndAddrType == Socks5AddressType.IPv4) {
                if (!NetUtil.isValidIpV4Address((String)bndAddr)) {
            ...
            } else if (bndAddrType == Socks5AddressType.IPv6 && !NetUtil.isValidIpV6Address((String)bndAddr)) {
