...
implements Socks5CommandRequest {
    ...
    public DefaultSocks5CommandRequest(Socks5CommandType type, Socks5AddressType dstAddrType, String dstAddr, int dstPort) {
        this.type = (Socks5CommandType)ObjectUtil.checkNotNull((Object)type, (String)"type");
        ObjectUtil.checkNotNull((Object)dstAddrType, (String)"dstAddrType");
        ObjectUtil.checkNotNull((Object)dstAddr, (String)"dstAddr");
        if (dstAddrType == Socks5AddressType.IPv4) {
            if (!NetUtil.isValidIpV4Address((String)dstAddr)) {
        ...
        } else if (dstAddrType == Socks5AddressType.IPv6 && !NetUtil.isValidIpV6Address((String)dstAddr)) {
