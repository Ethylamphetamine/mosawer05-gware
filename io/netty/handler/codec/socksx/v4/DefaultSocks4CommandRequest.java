...
implements Socks4CommandRequest {
    ...
    public DefaultSocks4CommandRequest(Socks4CommandType type, String dstAddr, int dstPort, String userId) {
        ...
        this.type = (Socks4CommandType)ObjectUtil.checkNotNull((Object)type, (String)"type");
        this.dstAddr = IDN.toASCII((String)ObjectUtil.checkNotNull((Object)dstAddr, (String)"dstAddr"));
        this.userId = (String)ObjectUtil.checkNotNull((Object)userId, (String)"userId");
